...
export const Battleground: React.FC<BattlegroundProps> = ({
  ...
  return (
    <div className="flex-1 w-full flex items-center justify-center gap-3 sm:gap-8 md:gap-12 lg:gap-16 py-1 sm:py-2 px-2">
        ...
        <div className="relative bg-stone-950 border-2 border-amber-500/60 p-3 sm:p-4 md:p-5 rounded-full shadow-[0_0_40px_rgba(245,158,11,0.2),0_20px_50px_rgba(0,0,0,0.9)] flex flex-col items-center justify-center min-w-[110px] sm:min-w-[140px] transform hover:scale-105 transition-all duration-300 group flex-shrink-0 z-10">
