...
export const Battleground: React.FC<BattlegroundProps> = ({
  ...
  return (
    <div className="flex-1 w-full flex items-center justify-center gap-3 sm:gap-8 md:gap-12 lg:gap-16 py-1 sm:py-2 px-2">
        ...
        <div className={`relative bg-stone-950 border-2 p-3 sm:p-4 md:p-5 rounded-full flex flex-col items-center justify-center min-w-[110px] sm:min-w-[140px] transform hover:scale-105 transition-all duration-500 group flex-shrink-0 z-10 ${
            isAnteReveal
